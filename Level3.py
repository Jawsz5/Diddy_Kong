...
class Level3(Level):
    def __init__(self, up, down, left, right):
        ...
        self.Game_Over_Buttons = Button(self.screen, "Play Again", SCREENW // 2 - 100, 525, 200, 50)
        self.Game_Over_Buttons1 = Button(self.screen, "Back to Menu", SCREENW // 2 - 100, 600, 200, 50)
